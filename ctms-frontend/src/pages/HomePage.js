...
const HomePage = () => {
  ...
  const [agencyAnchorEl, setAgencyAnchorEl] = useState(null);
    ...
    <>
      ...
      <AppBar position="static" sx={{ backgroundColor: '#8D6E63' }}>
        <Toolbar>
          ...
          <IconButton color="inherit" onClick={(e) => setAgencyAnchorEl(e.currentTarget)}>
            For Agencies <ArrowDropDownIcon />
          </IconButton>
          <Menu
            anchorEl={agencyAnchorEl}
            open={Boolean(agencyAnchorEl)}
            onClose={() => setAgencyAnchorEl(null)}
          >
            <MenuItem onClick={() => { navigate('/agency-login'); setAgencyAnchorEl(null); }}>
              Login
            </MenuItem>
          </Menu>

          {/* For Clients Dropdown */}
          <IconButton color="inherit" onClick={(e) => setClientAnchorEl(e.currentTarget)}>
            For Clients <ArrowDropDownIcon />
          </IconButton>
          <Menu
          ...
          >
            <MenuItem onClick={() => { navigate('/login'); setClientAnchorEl(null); }}>
              Login
            </MenuItem>
          </Menu>
        </Toolbar>
